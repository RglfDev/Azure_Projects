...
const external_event_tracker_1 = require("./external_event_tracker");
...
class OnTheWireMessageContainer {
    ...
    purge(err) {
        const errorForPurgedMessage = err || new azure_iot_common_1.errors.NotConnectedError('Connect was lost');
        const existing = this._onTheWire;
        this._onTheWire = new Map();
        //
    ...
    _timeout() {
        const secondsSinceTheEpoch = Math.round(Date.now() / 1000);
 ...
 * @private
 */
class MqttBase extends events_1.EventEmitter {
        ...
        this._fsm = new machina.Fsm({
            ...
            states: {
                disconnected: {
                    ...
                    publish: (_topic, _payload, _options, callback) => callback(new azure_iot_common_1.errors.NotConnectedError()),
                    ...
                    subscribe: (_topic, _options, callback) => callback(new azure_iot_common_1.errors.NotConnectedError()),
                    ...
                    unsubscribe: (_topic, callback) => callback(new azure_iot_common_1.errors.NotConnectedError()),
                ...
                connected: {
                    ...
                    connect: (callback) => callback(null, new azure_iot_common_1.results.Connected()),
                    ...
                    closeEvent: () => {
                        this._fsm.transition('disconnected', undefined, new azure_iot_common_1.errors.NotConnectedError('Connection to the server has been closed.'));
                    }
                },
                disconnecting: {
                ...
                reconnecting: {
                    _onEnter: (callback) => {
                        ...
                        this._disconnectClient((_c = (_b = (_a = this._options) === null || _a === void 0 ? void 0 : _a.mqtt) === null || _b === void 0 ? void 0 : _b.forceDisconnect) !== null && _c !== void 0 ? _c : false, () => {
    ...
    _connectClient(callback) {
        ...
        const createErrorCallback = (eventName) => {
            return (error) => {
                ...
                const err = error || new azure_iot_common_1.errors.NotConnectedError('Unable to establish a connection');
                callback(err);
            };
        };
        ...
        this._mqttTrackedListeners = new external_event_tracker_1.ExternalEventTracker(this._mqttClient);
    ...
    _disconnectClient(forceDisconnect, callback) {
